...
The public installer does not fetch a private repository. Authentication for Codex, OpenCode, NetBird, RustDesk, Termix, and other user accounts remains a manual step after installation.
