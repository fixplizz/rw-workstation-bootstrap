...
The public installer does not fetch a private repository. Authentication for Orca agents, Codex, OpenCode, Hermes Agent, herdr integrations, NetBird, RustDesk, Termix, and other user accounts remains a manual step after installation.
