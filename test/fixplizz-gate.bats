...
@test "boot hard gate logs a large actionable failure before system changes" {
  ...
  [[ "$output" == *"Continue: bash -c 'set -o pipefail; curl -fsSL --retry 3 --retry-all-errors https://raw.githubusercontent.com/fixplizz/rw-workstation-bootstrap/v0.1.0-rc9/boot.sh | bash'"* ]]
